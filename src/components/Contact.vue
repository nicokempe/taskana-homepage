<template>
  <div
    id="contact"
    class="content-wrapper py-16 bg-gradient-to-br from-primary-600 to-secondary-600 dark:from-primary-900 dark:to-secondary-900 dark:bg-gray-800 dark:bg-opacity-50 "
  >
